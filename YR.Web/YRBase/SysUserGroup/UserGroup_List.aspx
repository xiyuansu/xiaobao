<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroup_List.aspx.cs"
    Inherits="YR.Web.YRBase.SysUserGroup.UserGroup_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/YRBase/SysUserGroup/UserGroup_Form.aspx?ParentId=" + UserGroup_ID;
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "/YRBase/SysUserGroup/UserGroup_Form.aspx?key=" + key;
        ...
        function allotMember() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "/YRBase/SysUserGroup/UserGroupSet.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
        ...
        function allotAuthority() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "/YRBase/SysUserGroup/AllotAuthority_Form.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
                Urlhref(url);
            }
        }
        //详细信息
        function detail() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "/YRBase/SysUserGroup/UserGroup_Info.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
                Urlhref(url);
            }
        }
    </script>
