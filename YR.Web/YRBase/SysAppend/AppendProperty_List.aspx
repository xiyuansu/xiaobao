<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppendProperty_List.aspx.cs"
    Inherits="YR.Web.YRBase.SysAppend.AppendProperty_List" %>
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            if (Function_Name != "未选择") {
                var url = "/YRBase/SysAppend/AppendProperty_Form.aspx?Function=" + escape(Function_Name);
        ...
        function edit() {
            ...
            var key = arrt[0];
            if (IsEditdata(key)) {
                var url = "/YRBase/SysAppend/AppendProperty_Form.aspx?key=" + key;
