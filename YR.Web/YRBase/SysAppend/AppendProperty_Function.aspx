<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppendProperty_Function.aspx.cs"
    Inherits="YR.Web.YRBase.SysAppend.AppendProperty_Function" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //添加
        function add() {
            var url = "/YRBase/SysAppend/AppendProperty_Function_Form.aspx";
        ...
        function edit() {
            ...
            if (IsEditdata(CheckboxValue())) {
                var url = "/YRBase/SysAppend/AppendProperty_Function_Form.aspx?key=" + key;
