<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Role_List.aspx.cs" Inherits="YR.Web.YRBase.SysRole.Role_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/YRBase/SysRole/Role_Form.aspx?ParentId=" + Roles_ID;
        ...
        function edit() {
            var key = Roles_ID;
            if (IsEditdata(key)) {
                var url = "/YRBase/SysRole/Role_Form.aspx?key=" + key;
        ...
        function allotAuthority() {
            var key = Roles_ID;
            if (IsEditdata(key)) {
                var url = "/YRBase/SysRole/AllotAuthority_Form.aspx?key=" + key + '&Roles_Name=' + escape(Roles_Name);
                Urlhref(url);
            }
        }
        //详细信息
        function detail() {
            var key = Roles_ID;
            if (IsEditdata(key)) {
                var url = "/YRBase/SysRole/Role_Info.aspx?key=" + key + '&Roles_Name=' + escape(Roles_Name);
                Urlhref(url);
            }
        }
    </script>
