<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_List.aspx.cs" Inherits="YR.Web.YRBase.SysMenu.Menu_List1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/YRBase/SysMenu/Menu_Form.aspx?ParentId=" + Menu_Id;
        ...
        function edit() {
            var key = Menu_Id;
            if (IsEditdata(key)) {
                var url = "/YRBase/SysMenu/Menu_Form.aspx?key=" + key;
        ...
        function allotButton() {
            var key = Menu_Id;
            if (IsEditdata(key)) {
                var url = "/YRBase/SysMenu/AllotButton_Form.aspx?key=" + key;
