<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Button_Form.aspx.cs" Inherits="YR.Web.YRBase.SysMenu.Button_Form" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SelectOpenImg() {
            var url = "../YRBase/SysMenu/Icons_List.aspx?Size=16";
            top.openDialog(url, 'Icons_List', '系统图标 - 选取', 615, 400, 100, 100);
        }
        //选取图标回调赋值
