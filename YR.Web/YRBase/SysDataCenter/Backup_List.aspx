<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Backup_List.aspx.cs" Inherits="YR.Web.YRBase.SysDataCenter.Backup_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //数据库备份
        function backups() {
            var url = "/YRBase/SysDataCenter/Backup_Confirm.aspx?type=0";
        ...
        function recover() {
            ...
            if (IsEditdata(CheckboxValue())) {
                if (arrt[0] == "备份") {
                    ...
                    var url = "/YRBase/SysDataCenter/Backup_Confirm.aspx?type=1";
