<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organization_List.aspx.cs"
    Inherits="YR.Web.YRBase.SysOrg.Organization_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "/YRBase/SysOrg/Organization_Form.aspx?ParentId=" + Organization_ID;
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "/YRBase/SysOrg/Organization_Form.aspx?key=" + key;
