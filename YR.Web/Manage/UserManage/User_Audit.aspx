<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Audit.aspx.cs" Inherits="YR.Web.Manage.UserManage.User_Audit" %>
...
<body>
    ...
    <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                ...
                <td>
                    <select id="RealNameCertification" runat="server">
