<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Financial_Analysis.aspx.cs" Inherits="YR.Web.Manage.UserManage.Financial_Analysis" %>
        ...
        <table id="table1" class="grid" singleselect="true">
            <thead>
                <tr>
                    ...
                    <td style="width: 22%;text-align: center;">订单支付金额</td>
                    <td style="width: 20%;text-align: center;">充值金额</td>
                    <td style="width: 24%;text-align: center;">押金缴纳金额</td>
                    <td style="width: 24%;text-align: center;">押金退款金额</td>
                </tr>
            </thead>
            <tbody>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="text-align: center;">
                                <%#Eval("PayTime")%></td>
                            <td style="text-align: center;">
                                <%#Eval("OrderPayMoney")%></td>
                            <td style="text-align: center;">
                                <%#Eval("ChangesAmount")%></td>
                            <td style="text-align: center;">
                                <%#Eval("DepositMoney")%></td>
                            <td style="text-align: center;">
                                <%#Eval("ReturnMoney")%></td>
                            </td>
                        </tr>
