<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_NoReportLoss.aspx.cs" Inherits="YR.Web.Manage.UserManage.User_NoReportLoss" %>
...
<body>
    ...
    <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                ...
                <td>
                    <input id="BindPhone" runat="server" />
                </td>
            </tr>
            <tr>
                <th>
