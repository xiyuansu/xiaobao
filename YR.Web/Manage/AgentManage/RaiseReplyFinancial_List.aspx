<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RaiseReplyFinancial_List.aspx.cs" Inherits="YR.Web.Manage.AgentManage.RaiseReplyFinancial_List" %>
                ...
                <asp:Repeater ID="rp_Item" runat="server" OnItemDataBound="rp_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 100px; text-align: center;">
                                <%# Convert.ToSingle(Eval("ChangesCoin"))<0?"<font color='red'>"+Eval("ChangesCoin")+"</font>":Eval("ChangesCoin")%>
                            </td>
                            <td style="width: 120px; text-align: center;">
                                <%#Eval("ChangesTime")%>
                            </td>
                            ...
                            <td style="width: 100px; text-align: center;">
                                <%#Asiasofti.SmartVehicle.Common.EnumHelper.GetEnumShowName(typeof(Asiasofti.SmartVehicle.Common.Enum.UserRaiseFinancialReflectWay), Convert.ToInt32(Eval("ReflectWay")))%>
                            </td>
                            <td style="width: 100px; text-align: center;">
                                <%#Eval("CurrentCoin")%>
                            </td>
