<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders_List.aspx.cs" Inherits="YR.Web.Manage.CustomerManage.Orders_List" %>
        ...
        <div style="float: left;">
            <table class="tabCondition">
                <tr>
                    ...
                    <th>充电桩名称</th>
                    <td>
                        <input type="text" id="txtVehicleName" runat="server" style="width: 158px;" placeholder="充电桩名称" tabindex="1" autocomplete="off"/>
                    </td>
                    <th>订单状态</th>
                    <td>
                ...
                <tr>
                    ...
                    <th>支付状态</th>
                    <td>
                        <select id="selPayState" class="Searchwhere2" runat="server" style="width: 162px;">
                            <option value="-1">全部</option>
                    ...
                    <th>订单金额</th>
                    <td>
                        <input id="txtStartSettlementMoney" runat="server" type="text" class="txt" style="width: 70px" placeholder="开始金额" tabindex="1" autocomplete="off" />-
                        <input id="txtEndSettlementMoney" runat="server" type="text" class="txt" style="width: 70px" placeholder="结束金额" tabindex="1" autocomplete="off" />
                    </td>
                </tr>
        ...
        <table id="table1" class="grid" singleselect="true">
            <thead>
                <tr>
                    ...
                    <td style="width: 100px;text-align: center;">充电桩</td>
                ...
                <asp:Repeater ID="rp_Item" runat="server" OnItemDataBound="rp_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <%#Asiasofti.SmartVehicle.Common.EnumHelper.GetEnumShowName(typeof(Asiasofti.SmartVehicle.Common.Enum.OrderPayState), Convert.ToInt32(Eval("PayState")))%>
                            </td>
                            <td style="text-align: center;">
                                <%#Eval("CreateTime")%>
                            </td>                            
