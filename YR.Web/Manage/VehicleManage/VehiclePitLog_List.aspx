<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehiclePitLog_List.aspx.cs" Inherits="YR.Web.Manage.VehicleManage.VehiclePitLog_List" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //新增
        function add() {
            var url = "/Manage/VehicleManage/VehiclePitLog_Form.aspx";
            top.openDialog(url, 'VehiclePitLog_Form', '维修记录 - 添加', 700, 350, 50, 50);
        }
        //编辑
        function edit() {
            var key = CheckboxValue();
            if (IsEditdata(key)) {
                var url = "/Manage/VehicleManage/VehiclePitLog_Form.aspx?key=" + key;
                top.openDialog(url, 'VehiclePitLog_Form', '维修记录 - 编辑', 700, 350, 50, 50);
            }
        }
        //删除
        function Delete() {
            var key = CheckboxValue();
            if (IsDelData(key)) {
                var delparm = 'action=Virtualdelete&module=维修记录&tableName=YR_VehicleMaintainLog&pkName=ID&pkVal=' + key;
        ...
        <div style="float: left;">
            <table class="tabCondition">
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtVehicleName" runat="server" placeholder="维修车辆名称" tabindex="1" autocomplete="off" />
                    </td>
                    <th>
                        维修项目
                    </th>
                    <td>
                        <input type="text" id="txtMaintainItems" runat="server" placeholder="维修项目" tabindex="1" autocomplete="off" />
                    </td>
                    <th>
                        维修时间
                    </th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtMaintainPeople" runat="server" placeholder="维修人" tabindex="1" autocomplete="off" />
                    </td>
                    <th>
                        维修人电话
                    </th>
                    <td colspan="7">
                        <input type="text" id="txtLinkPhone" runat="server" placeholder="维修人电话" tabindex="1" autocomplete="off" />
                    </td>
                </tr>
