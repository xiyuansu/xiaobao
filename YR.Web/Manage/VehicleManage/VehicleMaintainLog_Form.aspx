<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehicleMaintainLog_Form.aspx.cs" Inherits="YR.Web.Manage.VehicleManage.VehicleMaintainLog_Form" %>
...
<body>
    ...
    <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
            ...
            <tr>
                ...
                <td>
                    <input id="MaintainItems" runat="server" type="text" class="txt" datacol="yes" err="保养项目"
                ...
                <td>
                    <input id="MaintainPeople" runat="server" type="text" class="txt" datacol="yes" err="保养人"
                        checkexpession="NotNull" style="width: 200px" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="LinkPhone" runat="server" type="text" class="txt" datacol="yes" err="保养人电话"
                        checkexpession="NotNull" style="width: 200px" />
                </td>
                <th>
                    保养时间:
                ...
                <td>
                    <input id="MaintainTime" runat="server" type="text" class="txt" datacol="yes" err="保养时间" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss' })"
                        checkexpession="NotNull" style="width: 200px" />
                </td>
            </tr>
            <tr>
