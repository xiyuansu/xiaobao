    ...
    public partial class recharge_notify_url : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (sPara.Count > 0)//判断是否有带返回参数
            {
                ...
                Logger.Warn(string.Format("用户充值,支付宝支付通知,结果{0}", JsonConvert.SerializeObject(sPara)));
                if(aliNotify.GetSignVeryfy(sPara, sign)) //if (true)// 
                {
                    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    //请在这里加上商户的业务逻辑程序代码
                    ...
                    Logger.Warn(string.Format("用户充值,支付宝支付通知,订单号{0},支付单号{1},支付金额{2},支付宝用户号{3},支付宝账号{4}", out_trade_no, trade_no,total_fee,buyer_id,buyer_logon_id));
