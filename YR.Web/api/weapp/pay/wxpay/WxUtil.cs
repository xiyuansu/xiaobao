...
namespace YR.Web.api.weapp.pay.wxpay
{
    public class WxUtil
    {
        ...
        /// <param name="ip"></param>
        /// <returns></returns>
        public string GetPrepayId(string out_trade_no,string body, decimal paymoney,string notifyurl,string ip,string openID)
        {
            try
            {
                /*
                ...
                */
                ...
                _req_data += "<openid><![CDATA[" + dic["openid"] + "]]></openid> ";
