...
namespace YR.Web.api.operations.privacy
{
    ...
    /// 车辆充电
    /// </summary>
    public class VehicleCharging : IApiAction2
    {
        ...
        public string Execute(Hashtable params_ht)
        {
            ...
            else
            {
                ...
                if (!isSuccess)
                {
                    return SiteHelper.GetJsonFromHashTable(null, "faild", "车辆充电操作失败");
                }
                else
                {
                    ...
                    userOperateHT["OperateType"] = 4;
                    userOperateHT["OperateTypeText"] = "开始充电";
                    userOperateHT["Remark"] = "";
                    userOperateHT["OperateTime"] = SiteHelper.GetWebServerCurrentTime();
                    hum.AddUserOperate(userOperateHT);

                    return SiteHelper.GetJsonFromHashTable(null, "success", "车辆充电操作成功");
                }
            }
        }
    }
