<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeIndex.aspx.cs" Inherits="YR.Web.Frame.HomeIndex" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        /**修改密码**/
        function editpwd() {
            var url = "/YRBase/SysUser/UpdateUserPwd.aspx";
            top.openDialog(url, 'UpdateUserPwd', '修改登录密码', 400, 225, 50, 50);
        }
        //新增快捷功能
        function add_HomeShortcut() {
            var url = "/YRBase/SysPersonal/HomeShortcut_Form.aspx";
