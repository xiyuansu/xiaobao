<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainDefault.aspx.cs" Inherits="YR.Web.Frame.MainDefault" %>
                ...
                try {
                    ...
                    for (var i = 0; i < json.MENU.length; i++) {
                        ...
                        if (menu.PARENTID == 0) {
                            ...
                            $("#htmlMenuSelect").append("<div class=\"" + css + "\" onclick=\"GetSeedMenu(this,'" + menu.MENU_ID + "')\"><img src='/Themes/Images/32/"+menu.MENU_IMG+"' />" + menu.MENU_NAME + "</div>");
                            j++;
                        }
                    }
                } catch (e) {
