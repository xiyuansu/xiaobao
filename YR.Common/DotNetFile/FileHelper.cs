...
namespace YR.Common.DotNetFile
{
    /// <summary>
    /// 文件帮助类
    /// </summary>
    public class FileHelper
    {
        ...
        /// 创建系统异常日志
        /// </summary>
        protected static Log Logger = LogFactory.GetLogger(typeof(FileHelper));
        /// <summary>
        /// 将流读取到缓冲区中
        /// </summary>
        ...
        public static bool Base64ToImage(string photo, string filePath)
        {
            ...
            {
                Logger.Error("base64编码的文本转为图片出现异常\r\n" + e.Message + "\r\n base64编码" + photo + "\r\n");
                return false;
            }
        }
        /// <summary>
