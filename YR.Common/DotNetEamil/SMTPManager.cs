...
namespace YR.Common.DotNetEamil
{
    /// <summary>
    /// 发送邮件
    /// </summary>
    public class SMTPManager
    {
        ...
        {
            string MailUser =ConfigHelper.GetAppSettings("MailUser");
            string MailName =ConfigHelper.GetAppSettings("MailName");
            string MailHost =ConfigHelper.GetAppSettings("MailHost");
            string MailPwd =ConfigHelper.GetAppSettings("MailPwd");
